                    ...
                    for row in values:
                        try:
                            ...
                            if row[0] not in (None, ""):
                                ...
                                if search_product and search_product.type == 'consu' and search_product.is_storable is True and row[3] != '':
                                    ...
                                    if quant_id:
                                        ...
                                        if row[1] not in (None, ""):
                                            if search_product.is_storable is True and search_product.tracking == 'serial':
                                                if str(row[1]) != str(1):
                                                    if str(row[1]) == str(0):
                                                        quant_vals.update(
                                        ...
                                        if row[3] not in (None, ""):
                                            ...
                                            if search_lot:
                                                ...
                                                created_lot = stock_production_lot_obj.search([
                                                    ('name', '=', row[3]),
                                                    ('product_id', '=',
                                                     search_product.id)
                                                ], limit=1)
                                    ...
                                    skipped_line_no[str(
                                        counter)] = " - Product not found or it's not a Storable Product or it's not traceable by lot/serial number. "
                                    counter = counter + 1
                                    continue
                            else:
                                skipped_line_no[str(
