...

{
    ...
    "version": "0.0.2",
    "depends": ["stock_account", "mrp", "purchase","sale_management", "account", "stock", "purchase_stock", "sale_stock" ],
    "data": [
        ...
        'sh_purchase_backdate/wizard/sh_purchase_backdate_wizard_views.xml',
